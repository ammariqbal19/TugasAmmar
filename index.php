...
<head>
    ...
    <title>HOME | PSIS SEMARANG</title>
...
<body>
    ...
    <main>
        <div class="center">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSA3QLy45TSn2Y-GAzi2cKyPTiPTK_Xysrv5Q&s" alt="PSIS Semarang Logo" width="230">
        </div>
        ...
        <section>
            <h3>Urutan Sejarah PSIS Semarang</h3>
            <ol>
                <li>Era Perserikatan
                    <ul>
                        <li>Era divisi Utama</li>
                        <li>Juara Liga Indonesia</li>
                    </ul>
                </li>
                <li>Berlaga di Divisi 1</li>
            </ol>
        </section>
    </main>
